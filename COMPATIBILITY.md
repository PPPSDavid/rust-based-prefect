...
- Not yet supported (open gaps — not parity claims):
  ...
  - **Hard terminate** under pure `ThreadPoolTaskRunner` (CPython cannot kill threads); use `ProcessPoolTaskRunner` for SIGTERM/SIGKILL. UI pause-mode chooser still open (P3.2e).
