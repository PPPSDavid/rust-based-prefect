...
### Using a numbered release (e.g. v0.2.0)
...
Replace `v0.2.0` with the [latest release tag](https://github.com/PPPSDavid/rust-based-prefect/releases).
...
- Current release: see GitHub [**Releases**](https://github.com/PPPSDavid/rust-based-prefect/releases) (e.g. **v0.2.0**). Single version in **`VERSION`**, kept in sync with Rust, Python packages, and `frontend/package.json` (`python scripts/check_version_sync.py`).
