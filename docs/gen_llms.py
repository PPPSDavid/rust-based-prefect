...
PAGES: list[tuple[str, str, str]] = [
    ...
    (
        ...
        "how-to/worker-http-mode/",
        "HTTP claim API; no shared DB volume.",
    ),
    (
...
with gen_open("llms.txt", "w") as f:
    ...
    for title, path, desc in PAGES:
        ...
        md_map = {
            ...
            "how-to/docker-quickstart/": "how-to/docker-quickstart.md",
            "how-to/docker-compose/": "how-to/docker-compose.md",
            "how-to/run-background-services/": "how-to/run-background-services.md",
            "how-to/database-postgres/": "how-to/database-postgres.md",
