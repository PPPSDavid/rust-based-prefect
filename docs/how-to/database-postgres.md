...
See also: [Docker Compose](docker-compose.md), [self-hosted storage RFC](https://github.com/PPPSDavid/rust-based-prefect/blob/main/docs/plans/self-hosted-storage-rfc.md), [environment variables](../reference/env-vars.md).
