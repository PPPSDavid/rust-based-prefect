...
The API process can run schedule ticks embedded (`FLOWOXIDE_ENABLE_SCHEDULER=1`,
...
(borrow that guide’s process layout; FlowOxide does not yet elect a multi-replica leader).
...
| --- | --- | --- |
| `FLOWOXIDE_SCHEDULER_INTERVAL_MS` | `1000` | Tick interval |
| `FLOWOXIDE_SCHEDULER_STALE_SECONDS` | `120` | Stale worker threshold |
