...
When something behaves differently from Prefect, **`COMPATIBILITY.md`** is the source of truth for what is intentional versus not yet implemented. For a sorted gap backlog (including deliberate and park items), see **`docs/plans/prefect-gap-canvas.md`**.
